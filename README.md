...
##### ```void draw_tile(unsigned int tileNum, unsigned int x, unsigned int y)``` - Draws the specified tile number from [tiles](#timesM) to the screen at the specified x and y position.
