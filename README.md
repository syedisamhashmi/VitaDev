...
## Read Please
#### I've seen that a couple of other people that aren't me have viewed this. That's great! Please, if you have **__any__** experience in developing for this target, **please** send me a message, I'm looking for advice and help and  I am open to suggestions. Thank you!
...
#### In addition, as can be seen, I am attempting to create my own graphics libraries from scratch. **__You can use Vita2D__**, but I have opted out of this, in order to further my learning experience. This includes rendering my own file format of rgba with a header, and my own functions to draw to the screen.
